...
# data/master_complete.csv = volle Historie; master_daily_update.csv = nur letzter Signaltag (ohne Forward); meta_holdout_signals.csv = Kopie von master_complete.
...
print(f'wrote data/master_complete.csv (+ meta_holdout_signals.csv) & master_daily_update.csv ({len(_ho_rows)} holdout rows)')
